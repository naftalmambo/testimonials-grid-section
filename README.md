...
- **Windows Browser (Chrome)** - Used for cross-browser testing to ensure it's responsive.
...
#### **Creating the Asymmetrical Grid**
I learned how to use `grid-column` and `grid-row` to create the complex desktop layout where cards have different sizes.

```css
.card-white-last {
  grid-column: 4;     /* Moves it to the far right */
  grid-row: span 2;   /* Makes it span the full height of the grid */
}
```
...
- **Responsiveness:** I believe I've tried my best to make this project as responsive as possible through use of a mobile-first approach, while also staying open to improvements.
...
- 🔭 **Open for work:** Looking for junior roles or freelance opportunities where I can apply my skills in HTML, CSS, and Javascript.
...
I want to express my sincere gratitude to **[Frontend Mentor](https://www.frontendmentor.io)** for providing these incredible, real-world challenges. This platform is a gateway for me to build skills that truly change lives.

## Credits

- **freeCodeCamp**: For the consistent practice that solidified my HTML and CSS fundamentals.
- **The Odin Project**: For teaching me how to set up my local working environment and think like a developer.
